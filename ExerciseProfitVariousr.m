...
exercise_profit = exercise_profit - 0.7731;
exercise_time = exercise_time(exercise_time ~=1);
exercise_profit = exercise_profit(exercise_profit ~=-0.7731);
...
exercise_profit = exercise_profit - 0.7514;
exercise_time = exercise_time(exercise_time ~=1);
exercise_profit = exercise_profit(exercise_profit ~=-0.7514);
...
exercise_profit = exercise_profit - 0.6404;
exercise_time = exercise_time(exercise_time ~=1);
exercise_profit = exercise_profit(exercise_profit ~=-0.6404);
...
exercise_profit = exercise_profit - 0.5274;
exercise_time = exercise_time(exercise_time ~=1);
exercise_profit = exercise_profit(exercise_profit ~=-0.5274);
...
leg = legend('r=0.005','r=0.01','r=0.02','r=0.04','r=0.08');
title("KDE of Exercise Profit for \sigma=0.02, \mu=0.05 and K=10 with various r");